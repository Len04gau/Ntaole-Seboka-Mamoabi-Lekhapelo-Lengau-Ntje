...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO institute (Name, Email, Password) VALUES ('$name', '$email', '$password')";
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Sign-up successful!'); window.location.href = 'institute.php';</script>";
    } else {
        echo "<script>alert('Error: " . $conn->error . "'); window.location.href = 'institute.php';</script>";
    }
}
...
<div class="container mt-5">
    <p>Welcome to the Institution panel. Use the button below to log in.</p>
    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#institutionModal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="institutionModalLabel">Institution Login</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="Institute Dashboard.php" method="POST">
                    <div class="mb-3">
